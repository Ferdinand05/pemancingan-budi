<nav class=" bg-sea-0 border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between md:mx-14 p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="/img/logo.png" class="h-10 md:h-16" alt="Pemancingan Budi" />
            <span class="self-center md:text-2xl font-semibold whitespace-nowrap dark:text-white">Pemancingan Budi</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <li>
                    <a href="{{ route('home') }}"
                        class="block py-2 px-3 hover:text-blue-700  bg-blue-700 rounded md:bg-transparent  md:p-0 dark:text-white md:dark:text-blue-500 @if (Request::routeIs('home')) md:text-blue-700 @endif"
                ...
                <li>
                    <a href="{{ route('blog') }}"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent @if (Request::routeIs('blog')) md:text-blue-700 @endif">Blog</a>
                </li>
                ...
                @auth
                    <li>
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            class=" text-center inline-flex items-center" type="button">{{ Auth::user()->name }} <svg
                        ...
                        <div id="dropdown"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                @endrole
                                <li>
                                    <a href="{{ route('settings.edit', Auth::user()->username) }}"
