<div id="default-carousel" class="relative w-full" data-carousel="slide">
    ...
    <div class="relative h-[400px]   overflow-hidden  md:h-[650px]">
        ...
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="relative top-1/3 z-50 text-white px-28">
                <h2 class="font-semibold md:text-4xl text-center md:text-start">Adrenalin!
                </h2>
            </div>
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <div class="relative top-1/3 z-50 text-white px-28">
                <h2 class="font-semibold md:text-4xl text-center md:text-start">Temukan Spot Memancing Terbaik di
                    Indonesia
                </h2>
            </div>
